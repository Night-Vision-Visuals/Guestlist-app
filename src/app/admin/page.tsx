      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-between px-6 md:px-16 py-12">
        ...
        <div className="flex items-center justify-center flex-1">
          <div className="w-full max-w-md">
            ...
            {/* Info Text */}
            <div className="text-xs text-neutral-600 tracking-[0.15em] uppercase">
              <p className="mb-2">Admin credentials required</p>
              <p className="text-neutral-700 text-[10px]">Contact your administrator for access</p>
            </div>
