  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Footer Section */}
        <div className="border-t border-orange-900/50 px-6 md:px-16 py-12 backdrop-blur-sm bg-black/60">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            ...
            <div>
              ...
              <p className="text-neutral-600 text-sm font-light leading-relaxed">
                <span style={{ fontFamily: "Futures, sans-serif" }}>Night Vision</span> brings together the most exclusive events with seamless management and curation.
              </p>
            </div>
