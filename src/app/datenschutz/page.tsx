        ...
        <div className="max-w-3xl mx-auto w-full flex-1">
          ...
          <div className="mb-12 space-y-4">
            ...
            <p className="text-neutral-400 text-sm tracking-[0.2em] uppercase font-light">
              Datenschutzerklärung — <span style={{ fontFamily: "Futures, sans-serif" }}>Night Vision</span> Visuals
            </p>
          ...
          <div className="space-y-10 text-neutral-300 font-light leading-relaxed">
            ...
            <section>
              ...
              <p className="text-sm">
                 Verantwortlicher im Sinne der Datenschutzgrundverordnung (DSGVO) ist <span style={{ fontFamily: "Futures, sans-serif" }}>Night Vision</span> Visuals.
